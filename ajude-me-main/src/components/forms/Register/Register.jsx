...
export default function RegisterForm({ bottonText, styleBotton }) {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        />
        <Dialog.Content
          onInteractOutside={handleBottonClickMain}
          className="fixed py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-4/5"
        >
          ...
          {userPsicologo && (
            <RegisterForPsicologos
              handleBottonClickMain={handleBottonClickMain}
              handleBottonClickBeneficiario={handleBottonClickBeneficiario}
            />
          )}
          {userBeneficiario && (
            <RegisterForBeneficiario
              handleBottonClickMain={handleBottonClickMain}
              handleBottonClickPsicologo={handleBottonClickPsicologo}
            />
          )}
