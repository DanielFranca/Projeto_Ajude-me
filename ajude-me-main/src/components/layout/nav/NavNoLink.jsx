...
export default function NavNoLink() {
  return (
    <nav className="flex justify-around py-4 mx-auto bg-gray-900 mr-36">
      ...
      <div className="items-center hidden space-x-8 lg:flex font-semibold hover:cursor-pointer">
        <a
          href="/"
          className="hover:text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-fuchsia-400 to-blue-400 transition duration-300 ease-in-out text-white "
        >
          Pagina Inicial
        </a>
        <a
          href="/#:~:text=Entenda-,Consultas%20volunt%C3%A1rias,-N%C3%B3s%20da%20ajude"
          className="hover:text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-fuchsia-400 to-blue-400 transition duration-300 ease-in-out text-white "
        >
