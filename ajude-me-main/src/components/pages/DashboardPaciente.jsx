...
import HistoricoDePagamento from "../forms/DashboardForms/HistoricoDePagamento";
...
export default function DashboardPaciente() {
  ...
  async function carregarPaciente() {
    ...
    try {
      await axios
        .get(
          `http://localhost:5000/api/v1/users/profile/paciente/${idPaciente}`
        )
        .then((response) => {
  ...
  async function carregarOutrasInformacoes() {
    let urlNumerosDeConsultas = `http://localhost:5000/api/v1/users/paciente/totalConsultas/${idPaciente}`;
  ...
  useEffect(() => {
    // console.log("O paciente tem consulta hoje? ", consultaHojeRender);
  }, [consultaHojeRender]);
  ...
  async function carregarConsultaDeHoje() {
    ...
    try {
      await axios
        .get(
          `http://localhost:5000/api/v1/users/paciente/consultarAgenda/${idPaciente}`
        )
        .then((response) => {
          // console.log(response.data);
  ...
  const loggedUndefined = localStorage.getItem("userPaciente") === "undefined";
        ...
        <header className="flex items-center h-20 px-6 sm:px-10 bg-purple-200">
          <div className="relative w-full max-w-md sm:-ml-2">
            ...
            <div className="items-center ">
              <h3 className=" font-halimum text-transparent bg-clip-text bg-gradient-to-r from-purple-900 via-fuchsia-400 to-blue-400 text-3xl">
                ajude.me
              </h3>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            ...
            <div className="flex flex-wrap items-start justify-end -mb-3">
              <HistoricoDePagamento
                bottonText="Histórico de Pagamento"
            ...
            <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
              ...
              <div className="p-4 flex-grow">
                <CommentForm
                  ...
                  idUsuario={localStorage.getItem("idPaciente")}
                />
